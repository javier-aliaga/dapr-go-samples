...
func (c *backendServiceClient) ListInstanceIDs(ctx context.Context, in *ListInstanceIDsRequest, opts ...grpc.CallOption) (*ListInstanceIDsResponse, error) {
	out := new(ListInstanceIDsResponse)
	err := c.cc.Invoke(ctx, BackendService_ListInstanceIDs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *backendServiceClient) GetInstanceHistory(ctx context.Context, in *GetInstanceHistoryRequest, opts ...grpc.CallOption) (*GetInstanceHistoryResponse, error) {
	out := new(GetInstanceHistoryResponse)
	err := c.cc.Invoke(ctx, BackendService_GetInstanceHistory_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBackendServiceServer) ListInstanceIDs(context.Context, *ListInstanceIDsRequest) (*ListInstanceIDsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListInstanceIDs not implemented")
}
func (UnimplementedBackendServiceServer) GetInstanceHistory(context.Context, *GetInstanceHistoryRequest) (*GetInstanceHistoryResponse, error) {
...
func _BackendService_ListInstanceIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListInstanceIDsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackendServiceServer).ListInstanceIDs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BackendService_ListInstanceIDs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackendServiceServer).ListInstanceIDs(ctx, req.(*ListInstanceIDsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _BackendService_GetInstanceHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetInstanceHistoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackendServiceServer).GetInstanceHistory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BackendService_GetInstanceHistory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackendServiceServer).GetInstanceHistory(ctx, req.(*GetInstanceHistoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BackendService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BackendService_ListInstanceIDs_Handler,
		},
		{
			MethodName: "GetInstanceHistory",
			Handler:    _BackendService_GetInstanceHistory_Handler,
		},
	},
