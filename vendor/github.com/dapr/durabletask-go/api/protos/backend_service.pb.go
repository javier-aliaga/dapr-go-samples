...
var file_backend_service_proto_rawDesc = []byte{
	...
	0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0x92, 0x12, 0x0a, 0x0e, 0x42, 0x61, 0x63, 0x6b, 0x65,
...
var file_backend_service_proto_goTypes = []interface{}{
	...
	(*ListInstanceIDsRequest)(nil),                // 49: ListInstanceIDsRequest
	(*GetInstanceHistoryRequest)(nil),             // 50: GetInstanceHistoryRequest
	(*CreateInstanceResponse)(nil),                // 51: CreateInstanceResponse
	(*GetInstanceResponse)(nil),                   // 52: GetInstanceResponse
	(*GetEntityResponse)(nil),                     // 53: GetEntityResponse
	(*QueryInstancesResponse)(nil),                // 54: QueryInstancesResponse
	(*QueryEntitiesResponse)(nil),                 // 55: QueryEntitiesResponse
	(*PurgeInstancesResponse)(nil),                // 56: PurgeInstancesResponse
	(*CleanEntityStorageResponse)(nil),            // 57: CleanEntityStorageResponse
	(*WorkItem)(nil),                              // 58: WorkItem
	(*HistoryChunk)(nil),                          // 59: HistoryChunk
	(*ListInstanceIDsResponse)(nil),               // 60: ListInstanceIDsResponse
	(*GetInstanceHistoryResponse)(nil),            // 61: GetInstanceHistoryResponse
}
var file_backend_service_proto_depIdxs = []int32{
	...
	49, // 57: durabletask.protos.backend.v1.BackendService.ListInstanceIDs:input_type -> ListInstanceIDsRequest
	50, // 58: durabletask.protos.backend.v1.BackendService.GetInstanceHistory:input_type -> GetInstanceHistoryRequest
	51, // 59: durabletask.protos.backend.v1.BackendService.CreateInstance:output_type -> CreateInstanceResponse
	1,  // 60: durabletask.protos.backend.v1.BackendService.AddEvent:output_type -> durabletask.protos.backend.v1.AddEventResponse
	52, // 61: durabletask.protos.backend.v1.BackendService.GetInstance:output_type -> GetInstanceResponse
	53, // 62: durabletask.protos.backend.v1.BackendService.GetEntity:output_type -> GetEntityResponse
	54, // 63: durabletask.protos.backend.v1.BackendService.QueryInstances:output_type -> QueryInstancesResponse
	55, // 64: durabletask.protos.backend.v1.BackendService.QueryEntities:output_type -> QueryEntitiesResponse
	3,  // 65: durabletask.protos.backend.v1.BackendService.WaitForInstance:output_type -> durabletask.protos.backend.v1.WaitForInstanceResponse
	...
	27, // 78: durabletask.protos.backend.v1.BackendService.GetMetrics:output_type -> durabletask.protos.backend.v1.GetMetricsResponse
	60, // 79: durabletask.protos.backend.v1.BackendService.ListInstanceIDs:output_type -> ListInstanceIDsResponse
	61, // 80: durabletask.protos.backend.v1.BackendService.GetInstanceHistory:output_type -> GetInstanceHistoryResponse
